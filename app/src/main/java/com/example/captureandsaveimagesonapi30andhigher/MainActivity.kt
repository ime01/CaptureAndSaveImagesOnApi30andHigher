package com.example.captureandsaveimagesonapi30andhigher
...
import com.example.captureandsaveimagesonapi30andhigher.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun sdkCheck():Boolean{
       ...
       /* if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q){
        ...
        return  if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) true else false

    }


    private fun requestPermission(){
        val isReadPermission = ContextCompat.checkSelfPermission(this, android.Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED
        val isWritePermission = ContextCompat.checkSelfPermission(this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED
